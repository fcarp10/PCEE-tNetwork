...
public class BasicEdgeParams extends EdgeParams{
	...
	public BasicEdgeParams(EdgeElement edge, double delay, double weight, double maxCapacity, String nameToDraw){
		this.setEdgeElement(edge);
		this.setDelay(delay);
	...
	public EdgeParams copyEdgeParams(EdgeElement newElement) {
		EdgeParams params = new BasicEdgeParams(newElement, delay, weight, maxCapacity, nameToDraw);
