...
public class VertexElement implements Comparable<VertexElement> {
	...
	/**default constructor*/
	public VertexElement(String vertexID, Gcontroller graph, double xCoord, double yCoord, String nameToDraw){
		this.vertexID = vertexID; 
		this.graph = graph;
		this.neighbourMap = new HashMap<VertexElement, ArrayList<EdgeElement>>();
		this.xCoord = xCoord;
	...
	public VertexElement copyVertexElement (Gcontroller newGraph){
		VertexElement element = new VertexElement (vertexID, newGraph, xCoord, yCoord, nameToDraw);
